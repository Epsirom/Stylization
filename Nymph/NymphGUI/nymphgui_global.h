...
#define AVAILABLE_OPEN_FILE_TYPES "Nymph Lua Script Files(*.nl;*.lua)"";;All Files(*.*)"
#define AVAILABLE_SAVE_FILE_TYPES "Nymph Lua Script Files(*.nl)"";;Nymph Lua Module Files(*.lua)"";;All Files(*.*)"
