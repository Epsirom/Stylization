...
void SynthesisProcessor::updateParameters(bool for_offline_synthesis, bool load_default = true)
{
    ...
    std::cout << "Got num styles" << std::endl;
    ...
    std::cout << "got objID weight" << std::endl;
    ...
    std::cout << "finish tsParams" << std::endl;
    ...
    std::cout << "finish grab levels" << std::endl;
    ...
    if (_renderPreviewStill) {
        std::cout << "Rendering preview still" << std::endl;
        ...
        std::cout << "Not rendering preview still" << std::endl;
...
void SynthesisProcessor::si_realtime_initSynthesis(bool cleanStyle, bool cleanImage)
{
    ...
    std::cout << "Finish: Update Parameters" << std::endl;
    _progress = 0;
    ...
    std::cout << "Style totally loaded" << std::endl;
